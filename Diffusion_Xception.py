...
train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True, num_workers=0, worker_init_fn=_init_fn)
val_loader = DataLoader(val_dataset, batch_size=16, shuffle=True, num_workers=0, worker_init_fn=_init_fn)
